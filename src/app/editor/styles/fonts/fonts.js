...
const stylingElements = {
  ...
  'small-capitals':
  class SmallCapitals extends Component {
    render() {
...
const arbitrarySize = {
  'arbitrary-size':
  class ArbitrarySize extends Component {
    render() {
